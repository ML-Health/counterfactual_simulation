...
if __name__ == "__main__":
    ...
    tf_device = 'gpu'
    if tf_device == "cpu":
        config = tf.compat.v1.ConfigProto(log_device_placement=False, device_count={'GPU': 0})
    else:
        config = tf.compat.v1.ConfigProto(log_device_placement=False, device_count={'GPU': 1})
